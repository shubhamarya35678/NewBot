...
@app.on_message(filters.command(["bear2addsudo"]) & filters.user(OWNER_ID))
@language
...
@app.on_message(filters.command(["bbdelsudo", "bbrmsudo"]) & filters.user(OWNER_ID))
@language
...
@app.on_message(filters.command(["bbdsudolist", "bbslistsudo", "bbssudoers"]) & ~BANNED_USERS)
@language
